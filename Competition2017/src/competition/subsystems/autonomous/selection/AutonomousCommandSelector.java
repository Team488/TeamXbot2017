...
public class AutonomousCommandSelector extends BaseSubsystem {
    ...
    public AutonomousCommandSelector(XPropertyManager propManager) {
        currentAutonomousCommandName = propManager.createEphemeralProperty("Current autonomous command name", "No command set");
    }
    ...
    public void setCurrentAutonomousCommand(Command currentAutonomousCommand) {
        ...
        this.currentAutonomousCommandName.set(currentAutonomousCommand == null
                ?"No command set" : currentAutonomousCommand.toString());
